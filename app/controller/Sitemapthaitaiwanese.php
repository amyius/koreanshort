...
class Sitemapthaitaiwanese extends BaseController
{
    public function index()
    {
        ...
        $articles = Db::name('thai_taiwanese_dramas')->distinct(true)->order('created_at desc,years desc')->select();
        // 开始构建sitemap内容
        ...
        foreach ($articles as $info) {
            ...
            $infoName  = htmlspecialchars($info['name'],  ENT_QUOTES, 'UTF-8');
